...
$transactions = $data['transactions']->getAllFromDB();
    ...
    <div class="page-content">
        ...
        <div class=page-content-body>
            ...
            <div class="tabs-container">
                ...
                <div class="tabs">
                    <div class="tab active" data-tab="act-checking" onclick="switchTab('act-checking')">Акты сверки</div>
                    <div class="tab" data-tab="accountable-funds" onclick="switchTab('accountable-funds')">Подотчетные средства</div>
                    <div class="tab" data-tab="cash-transactions" onclick="switchTab('cash-transactions')">Кассовые операции</div>
                    <div class="tab" data-tab="debt-accounting" onclick="switchTab('debt-accounting')">Учет долгов</div>
                </div>
            </div>

            <div class="tab-content" id="act-checkingContainer">
                <div class="act-checking-tab-container">
                    <label class="financial-accounting-first-label">Создать акт сверки</label>
                        ...
                        <div class="financial-accounting-first__create">
                            <div class="financial-accounting-first__create-forms">
                                ...
                                <ul class="financial-accounting-first__create-second-column">
                                    ...
                                    <li><input type="date" placeholder="Дата"></li>
                                </ul>
                            </div>
                            <div class="financial-accounting-first__note-container">
                                <button class="financial-accounting-first__note-button" onclick="toggleNoteField('note-field-1')">Добавить примечание</button>
                                <div class="financial-accounting-first__note-field-container" id="note-field-1">
                                    <textarea class="financial-accounting-first__note-field" placeholder="Введите комментарий"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="financial-accounting-first__list-container">
                        <label class="financial-accounting-first__list-label">Акты сверки</label></label>
                                ...
                                <tbody>
                                    <?php foreach ($suppliers as $supplier): ?>
                                        <tr>
                                            <td><?= $supplier->id() ?></td>
                                            <td><?= $supplier->name() ?></td>
                                            <!-- Если у вас нет данных о сумме и дате, используйте заглушки или получите их из БД -->
                                            <td>14 500.00</td>
                                            <td>11.09.2009</td>
                                            <td>
        ...
        <div class="tab-content" id="accountable-fundsContainer" style="display: none;">
            <div class="accountable-funds-tab-container">
                <label class="financial-accounting-first-label">Создать авансовый отчет</label>
                <div class="financial-accounting-first-container">
                    <div class="financial-accounting-first__create">
                        <div class="financial-accounting-first__create-forms">
                            <ul class="financial-accounting-first__create-first-column">
                                <li>
                                ...
                                <li>
                                    <select class="financial-accounting-first__create-select">
                                        <option disabled selected>Назначение</option>
                                        <?php foreach ($transactionTypes as $transactionType => $transactionType_model) : ?>
                                            <option value="<?= $transactionType_model->id() ?>"><?= $transactionType_model->purpose() ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </li>
                            </ul>
                        ...
                        <div class="financial-accounting-first__note-container">
                            <button class="financial-accounting-first__note-button" onclick="toggleNoteField('note-field-2')">Добавить примечание</button>
                            <div class="financial-accounting-first__note-field-container" id="note-field-2">
                                <textarea class="financial-accounting-first__note-field" placeholder="Введите комментарий"></textarea>
                            </div>
                        </div>
                        <div class="financial-accounting-first__buttons">
                ...
                <div class="financial-accounting-first__list-container">
                    <label class="financial-accounting-first__list-label">Авансовые отчеты</label></label>
                    <div class="financial-accounting-first__list">
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($employees as $employee): ?>
                                    <tr>
                                        <?php
                                        // Формируем ФИО: Фамилия И.О. 
                                        $fio = $employee->last_name()
                                            . ' ' . mb_substr($employee->name(), 0, 1) . '.'
                                            . ($employee->surname() ? ' ' . mb_substr($employee->surname(), 0, 1) . '.' : '');
                                        ?>

                                        <td><?= $fio ?></td>
                                        <!-- Пока что данные о назначении, сумме и дате — заглушки -->
                                        <td>Закрыть ипотеку</td>
                                        <td>14 500.00</td>
                                        <td>11.09.2009</td>
        ...
        <div class="tab-content" id="cash-transactionsContainer" style="display: none;">
            <div class="cash-transaction-tab-container">
                <label class="financial-accounting-first-label">Создать кассовую операцию</label>
                <div class="financial-accounting-first-container">
                    <div class="financial-accounting-first__create">
                        <div class="financial-accounting-first__create-forms">
                            <ul class="financial-accounting-first__create-first-column">
                                ...
                                <li>
                                    <select class="financial-accounting-first__create-select">
                                        <option disabled selected>Касса</option>
                                        <?php foreach ($cashRegisters as $cashRegister => $cashRegister_model) : ?>
                                            <option value="<?= $cashRegister_model->id() ?>"><?= $cashRegister_model->name() ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </li>
                            </ul>
                            <ul class="financial-accounting-first__create-second-column">
                                ...
                                <li><input type="date" placeholder="Дата"></li>
                                <div class="financial-accounting-first__note-container">
                                    <button class="financial-accounting-first__note-button" onclick="toggleNoteField('note-field-3')">Добавить примечание</button>
                                    <div class="financial-accounting-first__note-field-container" id="note-field-3">
                                        <textarea class="financial-accounting-first__note-field" placeholder="Введите комментарий"></textarea>
                                    </div>
                                </div>
                            </ul>
                ...
                <div class="financial-accounting-first__list-container">
                    <label class="financial-accounting-first__list-label">Кассовые операции</label></label>
                    <div class="financial-accounting-first__list">
                        <table>
                            <thead>
                                <tr>
        ...
        <div class="tab-content" id="debt-accountingContainer" style="display: none;">
            <div class="debt-accounting-tab-container">
                <label class="financial-accounting-first-label">Создать долг</label>
                <div class="financial-accounting-first-container">
                    <div class="financial-accounting-first__create">
                        <div class="financial-accounting-first__create-forms">
                            <ul class="financial-accounting-first__create-first-column">
                                ...
                                <li>
                                    <input type="date" placeholder="Дата возникновения">
                                </li>
                                <li>
                                    <input type="date" placeholder="Срок погашения">
                                </li>
                            </ul>
                            <ul class="financial-accounting-first__create-second-column">
                                <li>
                                    <select class="financial-accounting-first__create-select">
                                        <option disabled selected>Статус долга</option>
                                        <?php foreach ($debts as $debt) : ?>
                                            <option value="<?= $debt->id() ?>"><?= $debt->status() ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </li>
                                <li><input type="number" placeholder="Сумма, ₽"></li>
                                <div class="financial-accounting-first__note-container">
                                    <button class="financial-accounting-first__note-button" onclick="toggleNoteField('note-field-4')">Добавить примечание</button>
                                    <div class="financial-accounting-first__note-field-container" id="note-field-4">
                                        <textarea class="financial-accounting-first__note-field" placeholder="Введите комментарий"></textarea>
                                    </div>
                                </div>
                            </ul>
                ...
                <div class="financial-accounting-first__list-container">
                    <label class="financial-accounting-first__list-label">Долги</label></label>
                    <div class="financial-accounting-first__list">
                        <table>
                            <thead>
                                <tr>
