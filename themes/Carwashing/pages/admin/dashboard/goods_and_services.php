                        ...
                        <div class="goods-form-section">
                            ...
                            <div class="goods-form-information">
                                ...
                                <div class="goods-form-note-section">
                                    <button class="goods-form-note-button" onclick="toggleNoteField('note-field-goods')">Добавить примечание</button>
                                    <div class="goods-form-note-container" id="note-field-goods">
                        ...
                        <div class="goods-form-section">
                            <div class="goods-form-main-fields">
                                ...
                                <div class="goods-form-main-fields-inputs">
                                    ...
                                    <ul class="goods-form-main-fields-column">
                                        <li><input type="number" placeholder="Стоимость услуги"></li>
                                    </ul>
                                    
                                </div>
                                <div class="goods-form-main-fields-inputs">
                                    <input type="text" placeholder="Наименование услуги" >
                                </div>
